...
public class EjHsqldbDescrip {
    public static void main(String[] args) {
        try {
            ...
            String urlConexion = "jdbc:hsqldb:C:/Users/MateBook/Desktop/DAM/2ºDAM/ACDAT/TEMA 2/baseHsqldb/prac_embedidas";

            //Establecemos la conexion con la base de datos
            Connection conexion = DriverManager.getConnection(urlConexion, "SA", "");
